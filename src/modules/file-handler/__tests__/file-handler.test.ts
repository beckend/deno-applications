        ...
        group('option createDirectory', () => {
          ...
          test({
            ...
            async fn() {
              ...
              const results = await assertThrowsAsync(async () => {
                await targetFn(mockData)
              })

              assertEquals(
                results.message,
                'directory "." does not exist and option to create it is not true.'
              )
            },
          })
        })
              ...
              instance.DH.dependenciesSet({
                Deno: {
                  copy: async function (reader, file) {
                    ...
                    await Deno.copy(reader, Deno.stdout)
                    return 0
                  } as typeof Deno.copy,
        ...
        group('success', () => {
          test({
            ...
            async fn() {
              ...
              assertEquals(
                ...
                { ...options, readerSource: undefined }
              )
            },
          })
          ...
          test({
            ...
            async fn() {
              ...
              const resultsCreateDirectoryFalse = await assertThrowsAsync(() =>
                targetFn({
              ...
              assertEquals(
                resultsCreateDirectoryFalse.message,
        ...
        group('failure', () => {
          test({
            ...
            async fn() {
              ...
              const results = await assertThrowsAsync(() =>
                targetFn({
                  pathFile: '',
                })
              )
