...
import * as mock from 'https://deno.land/x/mock@0.10.1/mod.ts'
import { join } from 'https://deno.land/std@0.114.0/path/mod.ts'
import { generate as generateUUIDV5 } from 'https://deno.land/std@0.114.0/uuid/v5.ts'
...
> {
  ...
  static utils = {
    ...
    generateTempFilePath({
      ...
      readonly optionsGenerateUUIDV5?: {
      ...
      return join(
        ...
        `${TestUtilities.name}_` +
          generateUUIDV5(
            optionsGenerateUUIDV5.namespace || generateUUIDV4(),
            optionsGenerateUUIDV5.data ||
              TestUtilities.instances.textEncoder.encode(TestUtilities.name)
          )
      )
    },
    ...
    async executeAndClean<
      TFnExecute extends (x: {
        ...
        readonly generateTempFilePath: (x?: {
          readonly optionsGenerateUUIDV5?: {
            readonly data?: Uint8Array
            readonly namespace?: string
          }
